...
| FOREIGN-BODY-001 | Food Safety / QA (TBC) | Invented Fe/SS sizes, frequencies, auto-HOLD | foreign_body | ADR-038; PHASE_26_FOREIGN_BODY_CONTROL; APR-052 | 	est_phase26_foreign_body_control.py | TBC | Challenge shells + advisory containment; auto-HOLD default OFF | Phase 26 technical — company policy EVIDENCE REQUIRED |
