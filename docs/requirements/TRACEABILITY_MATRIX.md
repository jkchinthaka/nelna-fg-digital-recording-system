...
| TASK-001 | Operations / FG (TBC) | Missed tasks | scheduling | ADR-011; PHASE_06E_FG_QA_001_PROVISIONAL_WORKFLOW; PHASE_07_READINESS_GATE | PHASE_07A_TEST_PLAN | TBC | Per-batch provisional trigger (06E); ChecklistTask + batch_reference (07A); ProductionBatch master deferred | 07A technical foundation — real generation blocked until publish + batch source |
| TASK-002 | IT / Security (TBC) | Unauthorized task view | scheduling | ADR-011 | PHASE_07A_TEST_PLAN | TBC | Org-scoped view/manage_checklisttask | Phase 07A |
