...
| TEMPLATE-001 | Business / QA (TBC) | Uncontrolled forms | checklists | ADR-010; PHASE_06_CHECKLIST_PROVISIONAL_CONFIGURATION; CHECKLIST_DEFINITION_MANAGEMENT_UI; TEMPLATE_001_CHECKLIST_EVIDENCE_INTAKE; FG_QA_001_DRAFT_V0_1; FG_QA_001_DRAFT_LOADING; FG_QA_001_INTERNAL_VALIDATION_CHECKLIST | PHASE_06A_TEST_PLAN; checklist governance tests; PHASE_06C_TEST_PLAN; PHASE_06D_TEST_PLAN | TBC | Configurable unseeded definition engine (06A/06B); provisional response schema (06C); explicit DRAFT loader (06D); FG-QA-001 = PROJECT-PROPOSED DRAFT — VALIDATION REQUIRED; official forms = TEMPLATE evidence | Phase 06A/06B/06C/06D technical work — TEMPLATE not fully approved; draft proposal / DRAFT load not production; no production authorization |
