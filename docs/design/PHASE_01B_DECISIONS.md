...
| P1B-011 | Figma connector status | **Authenticated connector used; file created** | Agent / owner | whoami + create_new_file + use_figma | See FIGMA_IMPLEMENTATION_LOG for URL and remaining manual work | FIGMA_IMPLEMENTATION_LOG | Auth change |
| P1B-012 | High-fidelity screens deferred to Phase 01C | Accepted | Project owner | Phase boundary | Pages 06–12 stub until 01C | ROADMAP | 01B approval |
| P1B-013 | Manual Phase 01B approval required before 01C | Accepted | Project owner | Governance | PHASE_01B form must be signed | Approvals | — |
