...
| DES-017 | Operational visual direction: cool neutrals + teal primary; avoid purple marketing and cream/terracotta editorial defaults | Proposed (01B) | UX / Project owner (TBC) | Factory clarity + a11y | Brand book colours if provided | Token palette | DESIGN_TOKENS | Brand guidelines |
| DES-018 | Typography: Noto Sans Sinhala + Noto Sans stack | Proposed (01B) | IT / UX (TBC) | Sinhala coverage, open license | Other licensed Sinhala fonts | Type tokens | DESIGN_TOKENS | Font hosting decision |
