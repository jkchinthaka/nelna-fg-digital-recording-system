...
| Status | **06A-06N** — Engine v2 designed (ADR-019); 06H-06M technical foundations; **06N FG-QA-001 validation BLOCKED (no publish; APR-001 EVIDENCE REQUIRED)**; inventory NOT RECEIVED; FG-QA-001 remains project-proposed DRAFT; Phase 06 not fully complete |
