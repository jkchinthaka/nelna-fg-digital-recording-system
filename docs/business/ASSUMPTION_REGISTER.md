...
| Scheduling / recording / review | **08A/08B** draft + immutable submission complete; **09A** Supervisor review technical foundation complete; production recording/review + Phase 09B/10 still gated — see [PHASE_08_RECORDING_READINESS_GATE.md](PHASE_08_RECORDING_READINESS_GATE.md), [PHASE_09_SUPERVISOR_REVIEW_READINESS_GATE.md](PHASE_09_SUPERVISOR_REVIEW_READINESS_GATE.md) |
