...
| checklists | Definition/versioning (06A–06D); provisional workflow (06E); form discovery (06F); Engine v2 architecture (06G / ADR-019); repeating foundation (06H) | ChecklistTemplate, ChecklistVersion, ChecklistSection, ChecklistItem (+ Option; item_kind/parent/repeat_*) | Template/version lifecycle; DRAFT loader; management UI; REPEATING_GROUP children (06H) | No recording ownership in this app; no automatic RELEASE/HOLD/REJECT; FG-QA-001 never auto-published; no invented AQL | **06A–06H** |
