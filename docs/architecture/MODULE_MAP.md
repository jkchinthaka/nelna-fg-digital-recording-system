...
| checklists | Definition/versioning (06A–06D); provisional workflow (06E); form discovery (06F); Engine v2 architecture (06G / ADR-019); repeating (06H); calculated (06I); conditional rules (06J) | ChecklistTemplate, ChecklistVersion, ChecklistSection, ChecklistItem (+ Option; item_kind/parent/repeat_*/calculation_*/condition_rules), ChecklistItemRule | Template/version lifecycle; DRAFT loader; management UI; REPEATING_GROUP; closed CALCULATED operators; closed VISIBLE_IF/REQUIRED_IF/EVIDENCE_REQUIRED_IF predicates | No recording ownership in this app; no automatic RELEASE/HOLD/REJECT; FG-QA-001 never auto-published; no invented AQL/formulas/predicates | **06A–06J** |
