...
| checklists | Definition/versioning (06A–06D); provisional workflow (06E); form discovery (06F); Engine v2 architecture (06G / ADR-019); repeating (06H); calculated (06I) | ChecklistTemplate, ChecklistVersion, ChecklistSection, ChecklistItem (+ Option; item_kind/parent/repeat_*/calculation_*) | Template/version lifecycle; DRAFT loader; management UI; REPEATING_GROUP; closed CALCULATED operators | No recording ownership in this app; no automatic RELEASE/HOLD/REJECT; FG-QA-001 never auto-published; no invented AQL/formulas | **06A–06I** |
