...
| checklists | Definition/versioning (06A–06D); provisional workflow (06E); form discovery (06F); Engine v2 architecture (06G / ADR-019) | ChecklistTemplate, ChecklistVersion, ChecklistSection, ChecklistItem (+ Option) | Template/version lifecycle; DRAFT loader; management UI; v2 extension plan 06H–06M | No recording ownership in this app; no automatic RELEASE/HOLD/REJECT; FG-QA-001 never auto-published; v2 schema not implemented in 06G | **06A–06G** |
