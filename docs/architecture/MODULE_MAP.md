...
**Document status:** Living module boundaries — Phase 04–06A
**Phase:** 03–05 complete units · 06A checklist definitions · MASTER-001 / TEMPLATE pending
...
| 06 | **06A** configurable unseeded checklist definition/versioning (`checklists`); real forms after TEMPLATE evidence |
| 07 | `schedules`, `tasks` |
