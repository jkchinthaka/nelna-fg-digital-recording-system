...
| 07 | **07A** ChecklistTask foundation; **07B** batch-source contract; **07C** applicability; **07D** effective-version; **07E** recurring schedules; **07F** batch-event adapter (live contract required); **07G** task assignment (ownership ≠ authorization) |
