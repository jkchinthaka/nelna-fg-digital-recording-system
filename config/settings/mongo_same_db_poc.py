...
from config.settings.base import CACHE_KEY_PREFIX, INSTALLED_APPS as BASE_INSTALLED_APPS, env
...
# Silence unused MongoAdminConfig import warning path for type checkers.
...
# Password hasher for local POC speed; production cutover must use strong hashers.
PASSWORD_HASHERS = [
